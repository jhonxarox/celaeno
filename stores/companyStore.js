  ...
  actions: {
    async fetchCompanies() {
      const getRandomUsers = (count) => {
        ...
        return userImages.sort(() => Math.random() - 0.5).slice(0, count);
      };
